						...
						<div class="col-md-12 chit-chat-layer1-left">
							<div class="work-progres">
								...
								<div class="alert alert-success">
								   ...
								   <p>category :: <%=session.getAttribute("sentimentCategory") %></p>
								    <p>Probability ::<%=session.getAttribute("probability") %> </p>
								    <p>Aspect Result :: <%=session.getAttribute("aspectResult") %></p>
