            ...
            <div class="signup-main">
                ...
                <div class="signup-block">
                    <form action="./SignUp" method="post" onsubmit="return validation()">
                        ...
                        %>
                        <input type="text" name="full_name_text" placeholder="Fulll Name" required="">
                        <input type="text" name="mobile_number_text" placeholder="Mobile Number" required="">
                        <label>Login Credential</label>
                        <input type="text" name="email_id_text" placeholder="Email id" required=""> 
                        ...
                        <% if(userType.equals("Manager")){ %>
                           <input type="text" id="pass12" name="product_name"  placeholder="Product Name" required="" >
                        <% } %>
